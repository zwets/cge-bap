...
# CGE Services
#
cgmlstfinder	1.3.0	https://bitbucket.org/genomicepidemiology/cgmlstfinder.git
choleraefinder	1.0.0	https://bitbucket.org/genomicepidemiology/choleraefinder.git
speciesfinder   master  https://bitbucket.org/genomicepidemiology/speciesfinder.git
mlst	2.0.9	https://bitbucket.org/genomicepidemiology/mlst.git
plasmidfinder	3.0.1	https://bitbucket.org/genomicepidemiology/plasmidfinder.git
...
virulencefinder	3.2.0	https://bitbucket.org/genomicepidemiology/virulencefinder.git
#
# Excluded (for now)
...
kma	1.6.6	https://bitbucket.org/genomicepidemiology/kma.git
...
# 
ncbi-blast	2.17.0	https://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/@VERSION@/ncbi-blast-@VERSION@+-x64-linux.tar.gz
